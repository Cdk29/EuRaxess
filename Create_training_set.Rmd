...
This rmarkdown document is meant to keep track of the creation of the train and test set to create a classifier to recollect interresting job offers from Euraxess automatically. Most of the code came from Create_training_set_and_classifier.R. This document must be run using rmarkdown::render("MyDocument.Rmd", params = "ask").
